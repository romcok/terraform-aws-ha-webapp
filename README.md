...
|------|-------------|-------------|:----:|
| <a name="name"></a> [name](#input\_name) | | Module name | `string` |
| <a name="environment"></a> [environment](#input\_environment) | | Environment (`dev`, `prod`..) | `string` |
| <a name="region"></a> [region](#input\_region) | | Deployment region  | `string` |
| <a name="network"></a> [network](#input\_network) | | VPC network configuration | `object` |
| | <a name="network_cidr_block"></a> [cidr_block](#input\_network\_cidr_block) | VPC IPv4 CIDR block | `network` |
| | <a name="network_availability_zones"></a> [availability_zones](#input\_network\_availability_zones) | List of availability zones | `list(string)` |
| | <a name="network_public_subnet_cidrs"></a> [public_subnet_cidrs](#input\_network\_public_subnet_cidrs) | Public subnet IPv4 CIDR block per AZ | `list(string)` |
| | <a name="network_private_subnet_cidrs"></a> [private_subnet_cidrs](#input\_network\_private_subnet_cidrs) | Private subnet IPv4 CIDR block per AZ | `list(string)` |
| <a name="container"></a> [container](#input\_container) | | ECS Fargate configuration | `object` |
| | <a name="container_port"></a> [port](#input\_container\_port) | Container port number | `number` |
| | <a name="container_image"></a> [image](#input\_container\_image) | Docker image | `string` |
| | <a name="container_env_vars"></a> [env_vars](#input\_container\_env_vars) | List of environment Variables | `map(string)` |
| | <a name="container_secrets"></a> [secrets](#input\_container\_secrets) | List of SSM paramaters | `map(string)` |
| | <a name="container_cpu"></a> [cpu](#input\_container\_cpu) | Task CPU allocation | `number` |
| | <a name="container_memory"></a> [memory](#input\_container\_memory) | Task memory allocation | `number` |
| | <a name="container_count"></a> [count](#input\_container\_count) | Number of desired tasks | `number` |
| | <a name="container_volume_root"></a> [volume_root](#input\_container\_volume_root) | EFS volume root path | `string` |
| | <a name="container_mount_paths"></a> [mount_paths](#input\_container\_mount_paths) | Container mapping paths | `map(string)` |
| | <a name="container_health_check_path"></a> [healt_check_path](#input\_container\_healt_check_path) | Container health check path | `string` |
| <a name="database"></a> [database](#input\_database) | | Database configuration | `object` |
| | <a name="database_username"></a> [username](#input\_database\_username) | Database username | `string` |
| | <a name="database_password"></a> [password](#input\_database\_password) | Databvase password | `string` |
| | <a name="database_engine"></a> [engine](#input\_database\_engine) | Aurora RDS engine (`mysql` or `postgres`) | `string` |
| | <a name="database_port"></a> [port](#input\_database\_port) | Database port (3306 for `mysql`) | `number` |
| | <a name="database_version"></a> [version](#input\_database\_version) | Aurora RDS version | `string` |
| | <a name="database_instance"></a> [instance](#input\_database\_instance) | Aurora RDS instance class | `string` |
| | <a name="database_backup_retention_period"></a> [backup_retention_period](#input\_database\_backup_retention_period) | Database backup retention period in days | `number` |
| | <a name="database_skip_final_snapshot"></a> [skip_final_snapshot](#input\_database\_skip_final_snapshot) | Indicates whether to skip the last snapshot before destruction | `bool` |
| <a name="vpn"></a> [vpn](#input\_vpn) | | Client VPN configuration | `object` |
| | <a name="vpn_enabled"></a> [enabled](#input\_vpn\_enabled) | Indicates whether Client VPN service should be configured  | `bool` |
| | <a name="vpn_cidr_block"></a> [cidr_block](#input\_vpn\_cidr_block) | Client VPN IPv4 CIDR block | `string` |
| | <a name="vpn_server_private_key"></a> [server_private_key](#input\_vpn\_server_private_key) | Server private key | `string` |
| | <a name="vpn_server_certificate"></a> [server_certificate](#input\_vpn\_server_certificate) | Server certificate | `string` |
| | <a name="vpn_client_private_key"></a> [client_private_key](#input\_vpn\_client_private_key) | Client private key | `string` |
| | <a name="vpn_client_certificate"></a> [client_certificate](#input\_vpn\_client_certificate) | Client certificate | `string` |
| | <a name="vpn_certificate_authority"></a> [certificate_authority](#input\_vpn\_certificate_authority) | Certificate authority | `string` |
